...
name: ui-bridge
description: >
  Activate for any of the following: "ui-plan", "ui-implement", "ui-link",
  "build the UI", "design the pages", "prototype the screens",
  "turn the plan into HTML", "show me what it looks like",
  "create the frontend prototype", "link the html to the plan",
  or any request to generate, build, design, or preview HTML pages
  from a Spec Kit plan or tasks file.
---
